...
class WorldTraveler:
    ...
    async def _move_to(
        ...
        stack = []
        stack.append(
            (depth, direction, origin, destination, await self._get_next_directions_dict(origin), 0,
        ...
        while stack:
            ...
            if not cell.is_available_spot or (self.id in cell.visited and movement_type == MovementTypeEnum.Forward):
